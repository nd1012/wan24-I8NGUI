...
namespace wan24.I8NGUI
{
    ...
    public static class Startup
    {
        ...
        public static void Start(in GuiType guiType, in BuildType build)
        {
        ...
        public static async Task StartAsync(GuiType guiType, BuildType build, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="guiType">GUI type</param>
        /// <param name="build">Build type</param>
        private static void SyncStart(in GuiType guiType, in BuildType build)
        {
            ...
            //TODO ENV.IsBrowserApp = guiType == GuiType.WASM;
