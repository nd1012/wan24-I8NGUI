...
namespace wan24.I8NGUI
{
    ...
    /// Razor startup
    /// </summary>
    public static class RazorStartup
    {
        /// <summary>
        /// Start
        /// </summary>
        ...
        public static void Start(in GuiType guiType, in BuildType build, in IServiceCollection services)
        {
        ...
        public static async Task StartAsync(GuiType guiType, BuildType build, IServiceCollection services, CancellationToken cancellationToken = default)
        {
